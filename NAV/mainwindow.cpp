...
//    view->setAlignment(Qt::AlignLeft|Qt::AlignTop);
    ...
    qDebug()<<"current point init down\n";
...
void MainWindow::antfindStart() {
    ...
    //要跨校区，跨校区路段借用dij_second_bus/shuttle和cross_dis/time_v
        ...
        qDebug()<<"shahe shuttle abmap done\n";
        ...
        qDebug()<<"benbu shuttle abmap done\n";
        ...
        for(int i = 0; i<ant_shahe_spots_bus.size(); i++) {
            for(int j = 0; j<ant_benbu_spots_bus.size(); j++) {
                ...
                qDebug()<<"j("<<j<<") to i("<<i<<") time\n";

            }
        }
        qDebug()<<"bus all cross abmap done\n";
        ...
        qDebug()<<"shuttle all cross abmap done\n";
        ...
        qDebug()<<"ant_dis_bus convert to path done\n";
        ...
        qDebug()<<"ant_dis_shuttle convert to path done\n";
        ...
        qDebug()<<"ant_time_bus convert to path done\n";
        ...
        qDebug()<<"time_shuttle split done\n";
